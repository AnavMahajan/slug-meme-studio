 ...
 */function(e,t=""){if(!t)return!0;let o=[...new Set(t.split(",").map(e=>e.trim()).filter(Boolean))],i=e.type,a=i.replace(/\/.*$/,"");for(let t of o)if("."===t.charAt(0)){if(-1!==e.name.toLowerCase().indexOf(t.toLowerCase(),e.name.length-t.length))return!0}else if(/\/\*$/.test(t)){if(a===t.replace(/\/.*$/,""))return!0}else if(i===t)return!0;return!1}(i,this.accept),a=i.size>this.maxSize,n=i.size<this.minSize;if(!e||a||n){let t=[];e||t.push({code:"INVALID_MIME_TYPE",message:`File type "${i.type}" is not accepted.`}),a&&t.push({code:"FILE_TOO_LARGE",message:`File size ${i.size} exceeds the maximum size of ${this.maxSize}.`}),n&&t.push({code:"FILE_TOO_SMALL",message:`File size ${i.size} is smaller than the minimum size of ${this.minSize}.`}),o.push({file:i,errors:t})}else t.push(i)}this.dispatchEvent(new CustomEvent(`${te}-drop`,{bubbles:!0,composed:!0,detail:{acceptedFiles:t,rejectedFiles:o}})),t.length>0&&this.dispatchEvent(new CustomEvent(`${te}-drop-accepted`,{bubbles:!0,composed:!0,detail:{acceptedFiles:t}})),o.length>0&&this.dispatchEvent(new CustomEvent(`${te}-drop-rejected`,{bubbles:!0,composed:!0,detail:{rejectedFiles:o}})),this.#t&&(this.#t.value=this.#t.defaultValue)}openFileDialog(){this.disabled||this.#t?.click()}#l(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}}static defineCustomElement(t=te){"u">typeof window&&!window.customElements.get(t)&&window.customElements.define(t,e)}}).defineCustomElement();let ta=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"],tn=(e="",t="")=>{let o=Math.random().toString(36).substring(2,8);return`${"string"==typeof e&&""!==e?e+"-":""}${o}${"string"==typeof t&&""!==t?"-"+t:""}`},tr=async(e={})=>{let t=await fetch(e.url),o=await t.blob(),i=e.mimeType||o.type||"";if(!ta.includes(i))throw Error(`This is not an accepted image format. Accepted MIME types are: ${ta.join(", ")}`);return new File([o],e.filename||"",o)},ts=localStorage,tl=new class{#g=null;#b=null;constructor(e,t=localStorage){if(!e)throw Error("Storage prefix is required");if(t!==localStorage&&t!==sessionStorage)throw Error("Storage provider is not supported");this.#g=e,this.#b=t}set(e,t){try{this.#b.setItem(`${this.#g}${e}`,JSON.stringify(t))}catch(e){console.error("Error saving to storage",e)}}get(e){try{let t=this.#b.getItem(`${this.#g}${e}`);return t?JSON.parse(t):null}catch(e){return console.error("Error getting from storage",e),null}}}("meme-generator/",ts),td=e=>"string"==typeof e;var tc={};tc=s("aNJCr").getBundleURL("9p9yL")+"Pressuru.684952ea.ttf";var tu={};tu=s("aNJCr").getBundleURL("9p9yL")+"Oswald-Regular.89ec7d89.ttf";var th={};th=s("aNJCr").getBundleURL("9p9yL")+"Oswald-Bold.0f6a7ca6.ttf";var tm={};tm=s("aNJCr").getBundleURL("9p9yL")+"Roboto-Regular.ca197847.ttf";var tp={};tp=s("aNJCr").getBundleURL("9p9yL")+"Roboto-Bold.fdb9b54a.ttf";var tg={};tg=s("aNJCr").getBundleURL("9p9yL")+"RobotoCondensed-Regular.d585f5c7.ttf";var tb={};tb=s("aNJCr").getBundleURL("9p9yL")+"RobotoCondensed-Bold.e1f96d4b.ttf";var tf={};tf=s("aNJCr").getBundleURL("9p9yL")+"CourierPrime-Regular.3a25a501.ttf";var tv={};tv=s("aNJCr").getBundleURL("9p9yL")+"CourierPrime-Bold.3d6bf689.ttf";var ty={};ty=s("aNJCr").getBundleURL("9p9yL")+"OpenSans-Regular.edf9e01b.ttf";var tw={};tw=s("aNJCr").getBundleURL("9p9yL")+"OpenSans-Bold.8fceb72b.ttf";let tk=[{name:"Pressuru",label:"Pressuru",path:o(tc),style:"normal",weight:"400"},{name:"Oswald-Regular",label:"Oswald",path:o(tu),style:"normal",weight:"400"},{name:"Oswald-Bold",label:"Oswald Bold",path:o(th),style:"normal",weight:"700"},{name:"Roboto-Regular",label:"Roboto",path:o(tm),style:"normal",weight:"400"},{name:"Roboto-Bold",label:"Roboto Bold",path:o(tp),style:"normal",weight:"700"},{name:"RobotoCondensed-Regular",label:"Roboto Condensed",path:o(tg),style:"normal",weight:"400"},{name:"RobotoCondensed-Bold",label:"Roboto Condensed Bold",path:o(tb),style:"normal",weight:"700"},{name:"CourierPrime-Regular",label:"Courier Prime",path:o(tf),style:"normal",weight:"400"},{name:"CourierPrime-Bold",label:"Courier Prime Bold",path:o(tv),style:"normal",weight:"700"},{name:"OpenSans-Regular",label:"Open Sans",path:o(ty),style:"normal",weight:"400"},{name:"OpenSans-Bold",label:"Open Sans Bold",path:o(tw),style:"normal",weight:"400"}],tE=async(e,t,o={})=>{try{let i=new FontFace(e,`url(${t})`,{...o});await i.load(),document.fonts.add(i)}catch(e){console.error(e)}},tx=document.getElementById("errorsContainer"),tS=e=>{let t=e.currentTarget;t.removeEventListener("click",tS),tx.removeChild(t.parentNode)},tC=(e="",t="info")=>{["info","warning","danger"].includes(t)||(t="info");let o=`
  ...
  `,i=document.createElement("div");i.className=`alert alert-${t} alert-dismissible text-break mb-2 fade`,i.innerHTML=o,i.querySelector("button").addEventListener("click",tS),tx.appendChild(i),setTimeout(()=>i.classList.add("show"),100)},tA={id:"",text:"",fillColor:"#ffffff",strokeColor:"#000000",font:"Pressuru",fontSize:40,fontWeight:"normal",textAlign:"center",shadowBlur:0,strokeWidth:1.5,offsetY:0,offsetX:0,rotate:0,allCaps:!0},tj=new Map;class tL{constructor(e){let t=tn("textbox",Date.now().toString(36));this.data=e?{...e,id:t}:{...tA,id:t},tj.set(t,this),document.dispatchEvent(new CustomEvent("textbox-create",{bubbles:!0,composed:!0,detail:{textbox:this}}))}getData(){return this.data}static create(e){return new tL(e)}static getAll(){return tj}static getById(e){return tj.get(e)}static remove(e){tj.delete(e),document.dispatchEvent(new CustomEvent("textbox-remove",{bubbles:!0,composed:!0,detail:{id:e}}))}static createElement(e,t=!0){if(!(e instanceof tL))return;let o=e.getData(),{id:i,text:a,fillColor:n,strokeColor:r,fontSize:s,shadowBlur:l,strokeWidth:d,offsetX:c,offsetY:u,rotate:h}=o,m=`
    <div class="d-flex align-items-center">
      ...
      <textarea class="form-control meme-text" type="text" data-input="text" autocomplete="off" rows="1" placeholder="Text #${tj.size}">${a}</textarea>
  ...
  `,p=document.createDocumentFragment(),g=document.createElement("div");g.setAttribute("id",i),g.setAttribute("data-section","textbox"),g.className="bg-body-tertiary border shadow-sm mb-3 rounded",g.innerHTML=m,g.querySelectorAll("select").forEach(e=>e.value=o[e.dataset.input]),g.querySelectorAll('input[type="checkbox"]').forEach(e=>e.checked=o[e.dataset.input]);let b=p.appendChild(g);return t&&setTimeout(()=>b.querySelector('[data-input="text"]').focus(),0),b}}class tz{#f=null;#v=null;constructor(e){this.#f=e,this.#v=this.#f.getContext("2d")}get width(){return this.#f.width}set width(e){this.#f.width=e}get height(){return this.#f.height}set height(e){this.#f.height=e}getDimensions(){return{width:this.width,height:this.height}}setDimensions({width:e,height:t}){return this.width=e,this.height=t,this}toDataURL(){return this.#f.toDataURL()}draw(e,t=new Map){if(null==e)return;let o=this.#f,i=this.#v;i.clearRect(0,0,o.width,o.height),td(e)?(i.fillStyle=e,i.fillRect(0,0,o.width,o.height)):i.drawImage(e,0,0,o.width,o.height);let a=0;return t.forEach(e=>{let{data:t}=e;a+=1,i.save(),i.font=`${t.fontWeight} ${t.fontSize*o.width/1e3}px ${t.font}`,i.fillStyle=t.fillColor,i.textAlign=t.textAlign,i.strokeStyle=t.strokeColor;let n=i.measureText("M").width+t.fontSize/2,r=o.width/2,s=t.shadowBlur,l=(!0===t.allCaps?t.text.toUpperCase():t.text).split("\n");0!==s&&(i.shadowOffsetX=0,i.shadowOffsetY=0,i.shadowBlur=Math.min(s,20),i.shadowColor=t.strokeColor),i.translate(r+t.offsetX,n*a+t.offsetY),i.rotate(Math.min(t.rotate,360)*Math.PI/180),l.forEach((e,t)=>i.fillText(e,0,t*n)),0!==s&&(i.shadowBlur=0,l.forEach((e,t)=>i.fillText(e,0,t*n))),t.strokeWidth>0&&(i.lineWidth=Math.min(t.strokeWidth,20),l.forEach((e,t)=>i.strokeText(e,0,t*n))),i.restore()}),this}clear(){return this.#v.clearRect(0,0,this.#f.width,this.#f.height),this}show(){return this.#f.hidden=!1,this}hide(){return this.#f.hidden=!0,this}static createInstance(e){return new tz(e)}}let tT=tz.createInstance(document.getElementById("canvas")),tD=document.getElementById("videoModal"),t_=document.getElementById("downloadModal"),t$=document.querySelector("capture-photo"),tI=document.getElementById("cameraSelect"),tB=document.getElementById("capturePhotoButton"),tM=document.getElementById("torchButton"),tR=document.querySelector("files-dropzone"),tF=document.getElementById("instructions"),tN=document.getElementById("imageUploadMethodSelect"),tO=document.getElementById("fileSelectBtn"),tP=document.getElementById("imageUrlForm"),tq=document.getElementById("addTextboxBtn"),tU=document.getElementById("textboxesContainer"),tH=document.getElementById("generateMemeBtn"),tV=document.getElementById("openVideoModalBtn"),tW=document.getElementById("downloadMemeBtn"),tG=document.getElementById("downloadMemePreview"),tX=document.querySelector("web-share"),tY=document.getElementById("gallery"),tK=document.getElementById("gallerySearch"),tJ=tY.querySelector(".gallery__no-results"),tQ=document.getElementById("sluggallery"),tZ=document.getElementById("sluggallerySearch"),t0=tQ.querySelector(".sluggallery__no-results"),t1=document.getElementById("solidColorForm"),t3=document.querySelectorAll(".upload-method"),t5=document.getElementById("removeConfirmationModal"),t2=document.getElementById("removeTextForm"),t9=document.getElementById("maxImageDimensionsForm"),t4=t9.maxImageDimensions,t8=document.getElementById("clearCanvasBtn"),t6=tl.get("maxImageDimensions"),t7=!1,oe=null,ot=null,oo=async()=>{let e=tT.toDataURL("image/png"),t=`${tn("meme")}.png`,o=e.replace("image/png","image/octet-stream");if(tW.download=t,tW.href=o,tG.width=tT.getDimensions().width,tG.height=tT.getDimensions().height,tG.src=o,eW())try{let o=await tr({url:e,filename:t,mimeType:"image/png"}).catch(e=>tC(e.message,"danger"));o&&eW({files:[o]})&&(tX.shareFiles=[o],tX.hidden=!1)}catch(e){console.error(e)}window.requestAnimationFrame(()=>{t_.open=!0})},oi=e=>{let[t,o]=t9.maxImageDimensions.value.split("x"),i=Number(t)||800,a=Number(o)||600,n=e.width,r=e.height;n>r?n>i&&(r*=i/n,n=i):r>a&&(n*=a/r,r=a),tT.setDimensions({width:n,height:r})},oa=()=>{tT.draw(oe,tL.getAll()).show(),tR.classList.add("dropzone--accepted"),tR.disabled=!0,tH.disabled=!1,tF.hidden=!0,t8.hidden=!1},on=e=>{oi(oe=e.target),oa()},or=e=>{if(!e)return;let t=new Image,o=new FileReader;o.addEventListener("load",function(e){let o=e.target.result;t.addEventListener("load",on),t.src=o}),o.readAsDataURL(e)},os=(e,t,o)=>{let i=tL.getById(t).getData();switch(e.type){case"checkbox":i[o]=e.checked;break;case"number":i[o]=Number(e.value);break;default:i[o]=e.value}tT.draw(oe,tL.getAll())},ol=async e=>{e.preventDefault();let t=e.target,o=t.querySelector('button[type="submit"]'),i=t.imageUrl.value;if(i.trim()){o.disabled=!0,o.querySelector(".spinner").hidden=!1,o.querySelector(".label").hidden=!0;try{let e=await tr({url:i}).catch(e=>tC(e.message,"danger"));e&&or(e)}catch{tC(`Failed to load image from "${i}".`,"danger")}finally{o.disabled=!1,o.querySelector(".spinner").hidden=!0,o.querySelector(".label").hidden=!1}}},od=(e,t)=>()=>{let o=document.getElementById(e),i=o.querySelector('[data-input="offsetY"]'),a=o.querySelector('[data-input="offsetX"]'),n=tL.getById(e);if(!n)return;let r=n.getData();switch(t=t.toLowerCase()){case"up":r.offsetY-=1,i.value=r.offsetY;break;case"down":r.offsetY+=1,i.value=r.offsetY;break;case"left":r.offsetX-=1,a.value=r.offsetX;break;case"right":r.offsetX+=1,a.value=r.offsetX}tT.draw(oe,tL.getAll()),ot=requestAnimationFrame(od(e,t))},oc=document.getElementById("imageUploadDetails"),ou=async e=>{let t=e.target.closest("button");if(!t)return;let o=t.querySelector("img");try{let e=await tr({url:o.src}).catch(e=>tC(e.message,"danger"));e&&or(e)}catch{tC(`Failed to load image: "${o.alt}".`,"danger")}},oh=async e=>{let t=e.target.closest("button");if(!t)return;let o=t.querySelector("img");try{let e=await tr({url:o.src}).catch(e=>tC(e.message,"danger"));e&&or(e)}catch{tC(`Failed to load image: "${o.alt}".`,"danger")}},om=(e={})=>{let{el:t,isTorchOn:o}={el:document.getElementById("torchButton"),isTorchOn:!1,...e},i=t.querySelectorAll("svg path");2===i.length&&(i[0].style.display=o?"none":"block",i[1].style.display=o?"block":"none",t.setAttribute("aria-label",`Turn ${o?"off":"on"} flash`))},op=async e=>{let t=e.target.getTrackCapabilities();t?.torch&&(tM?.removeAttribute("hidden"),t$?.hasAttribute("torch")&&om({el:tM,isTorchOn:!0}));let o=await eV.getVideoInputDevices();o.forEach((e,t)=>{let o=document.createElement("option");o.value=e.deviceId,o.textContent=e.label||`Camera ${t+1}`,tI.appendChild(o)}),o.length>1&&tI?.removeAttribute("hidden")};document.addEventListener("tt-theme-change",e=>{let t=e.detail.theme,o=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";document.documentElement.setAttribute("data-bs-theme","system"===t?o:t)}),document.addEventListener("web-share:error",()=>{t_.open=!1,tC("There was an error while trying to share your meme.","danger")}),document.addEventListener("capture-photo:video-play",op,{once:!0}),document.addEventListener("capture-photo:error",e=>{let t=e.detail.error,o="An error occurred while trying to capture photo.";t instanceof Error&&("NotAllowedError"===t.name||"NotFoundError"===t.name)&&(o+=" Make sure you have a camera connected and you have granted the appropriate permissions."),tC(o,"danger"),tD.open=!1,console.error(t)}),document.addEventListener("capture-photo:success",e=>{tD.open=!1;let t=new Image;t.addEventListener("load",on),t.src=e.detail.dataURI}),document.addEventListener("me-open",e=>{"videoModal"===e.target.id&&t$&&"function"==typeof t$.startVideoStream&&t$.startVideoStream()}),document.addEventListener("me-close",e=>{"videoModal"===e.target.id&&t$&&"function"==typeof t$.stopVideoStream&&t$.stopVideoStream(),"removeConfirmationModal"===e.target.id&&t2.reset()}),document.addEventListener("emoji-click",e=>{let t=e.target.closest('[data-section="textbox"]');if(t){let o=t.querySelector('[data-input="text"]'),i=e.detail.unicode;o&&eO(o,i)}}),document.addEventListener("textbox-create",e=>{let t=e.detail.textbox,o=tL.createElement(t,t7);t7=!0,tU.appendChild(o),t.getData().text&&tT.draw(oe,tL.getAll())}),document.addEventListener("textbox-remove",e=>{let t=document.getElementById(e.detail.id);t&&t.remove(),tU.querySelectorAll('[data-section="textbox"]').forEach((e,t)=>{e.querySelector('[data-input="text"]').setAttribute("placeholder",`Text #${t+1}`)}),tT.draw(oe,tL.getAll())}),tO.addEventListener("click",()=>{"function"==typeof tR.openFileDialog&&tR.openFileDialog()}),tV.addEventListener("click",()=>{tD.open=!0}),tq.addEventListener("click",()=>tL.create()),tH.addEventListener("click",oo),tW.addEventListener("click",()=>t_.open=!1),tP.addEventListener("submit",ol),tR.addEventListener("files-dropzone-drop-accepted",e=>{let[t]=e.detail.acceptedFiles;t&&or(t)}),tU.addEventListener("input",e=>{let t;let o=e.target,i=o.closest('[data-section="textbox"]').id;o.matches('[data-input="text"]')?t="text":o.matches('[data-input="fillColor"]')?t="fillColor":o.matches('[data-input="strokeColor"]')?t="strokeColor":o.matches('[data-input="font"]')?t="font":o.matches('[data-input="fontSize"]')?t="fontSize":o.matches('[data-input="fontWeight"]')?t="fontWeight":o.matches('[data-input="textAlign"]')?t="textAlign":o.matches('[data-input="shadowBlur"]')?t="shadowBlur":o.matches('[data-input="offsetY"]')?t="offsetY":o.matches('[data-input="offsetX"]')?t="offsetX":o.matches('[data-input="rotate"]')?t="rotate":o.matches('[data-input="strokeWidth"]')&&(t="strokeWidth"),t&&os(o,i,t)}),tU.addEventListener("change",e=>{let t;let o=e.target,i=o.closest('[data-section="textbox"]').id;o.matches('[data-input="allCaps"]')&&(t="allCaps"),t&&os(o,i,t)}),tU.addEventListener("click",e=>{let t=e.target;if(t.matches('[data-button="settings"]')){let e=t.closest('[data-section="textbox"]'),o=e?.querySelector('[data-section="settings"]');o&&(o.hidden=!o.hidden)}if(t.matches('[data-button="duplicate-text-box"')){let e=t.closest('[data-section="textbox"]'),o=tL.getById(e.id);tL.create({...o.data})}if(t.matches('[data-button="delete-text-box"]')){let e=t.closest('[data-section="textbox"]').id,o=tL.getById(e);if(o&&o.data.text.trim()){let t=t2["textbox-id"];t&&(t.value=e,t5.open=!0)}else tL.remove(e)}}),tU.addEventListener("pointerdown",e=>{let t=e.target,o=t.closest('[data-section="textbox"]');o&&t.matches('[data-action="move-text"]')&&(ot=requestAnimationFrame(od(o.id,t.getAttribute("aria-label"))))}),tU.addEventListener("pointerup",e=>{e.target.matches('[data-action="move-text"]')&&(cancelAnimationFrame&&cancelAnimationFrame(ot),ot=null)}),tU.addEventListener("pointerout",e=>{e.target.matches('[data-action="move-text"]')&&(cancelAnimationFrame&&cancelAnimationFrame(ot),ot=null)}),tU.addEventListener("keydown",e=>{let t=e.target,o=t.closest('[data-section="textbox"]');t.matches('[data-action="move-text"]')&&(" "===e.key||"Enter"===e.key)&&(ot&&cancelAnimationFrame(ot),ot=requestAnimationFrame(od(o.id,t.getAttribute("aria-label"))))}),tU.addEventListener("keyup",e=>{e.target.matches('[data-action="move-text"]')&&(" "===e.key||"Enter"===e.key)&&(ot&&cancelAnimationFrame(ot),ot=null)}),tN.addEventListener("change",e=>{t3.forEach(t=>t.hidden=t.id!==e.target.value),t9.hidden="solidColorForm"===e.target.value,oc.removeAttribute("open")}),tY.addEventListener("click",ou),tK.addEventListener("input",e=>{let t=e.target.value.toLowerCase().trim();tY.querySelectorAll("button").forEach(e=>{let o=(e.querySelector("img").getAttribute("alt")||"").toLowerCase();e.hidden=!o.includes(t)}),tJ.hidden=!!tY.querySelector("button:not([hidden])")}),tQ.addEventListener("click",oh),tZ.addEventListener("input",e=>{let t=e.target.value.toLowerCase().trim();tQ.querySelectorAll("button").forEach(e=>{let o=(e.querySelector("img").getAttribute("alt")||"").toLowerCase();e.hidden=!o.includes(t)}),t0.hidden=!!tQ.querySelector("button:not([hidden])")}),t1.addEventListener("input",e=>{e.target===t1.canvasColor&&(oe=e.target.value),td(oe)&&(tT.setDimensions({width:Number(t1.canvasWidth.value)||800,height:Number(t1.canvasHeight.value)||600}),oa())}),t2.addEventListener("submit",e=>{e.preventDefault();let t=e.target["textbox-id"].value;t&&(tL.remove(t),t5.open=!1)}),t9.addEventListener("change",e=>{e.target.matches('[name="maxImageDimensions"]')&&tl.set("maxImageDimensions",e.target.value),!oe||td(oe)||(oi(oe),tT.draw(oe,tL.getAll()))}),t8.addEventListener("click",e=>{oe&&(e.stopPropagation(),oe=null,tR.classList.remove("dropzone--accepted"),tH.disabled=!0,tF.hidden=!1,t8.hidden=!0,tR.disabled=!1,tT.clear().hide())}),tI.addEventListener("change",e=>{if(null===t$||"function"!=typeof t$.restartVideoStream||t$.hasAttribute("loading"))return;let t=e.target.value||void 0;t$.restartVideoStream(t)}),tB.addEventListener("click",()=>{null===t$||"function"!=typeof t$.capture||t$.hasAttribute("loading")||t$.capture()}),tM.addEventListener("click",e=>{null!==t$&&(t$.torch=!t$.torch,om({el:e.currentTarget,isTorchOn:t$.hasAttribute("torch")}))}),tY.querySelectorAll("button > img")?.forEach(e=>{e.setAttribute("title",e.getAttribute("alt"))}),tQ.querySelectorAll("button > img")?.forEach(e=>{e.setAttribute("title",e.getAttribute("alt"))}),tL.create(),tR.accept=ta,((e,t)=>{if(!t)return;let o=e.map(e=>e.split("/")[1]),i=`Supported image formats: ${o.join(", ")}`,a=document.createElement("div"),n=document.createElement("small");n.textContent=i,a.appendChild(n),t.appendChild(n)})(ta,tF),tk.forEach(({name:e,path:t,style:o,weight:i})=>{tE(e,t,{style:o,weight:i})}),t6&&(t4.value=t6),t4.disabled=!1}();
//# sourceMappingURL=index.4abfebbc.js.map
