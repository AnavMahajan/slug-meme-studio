 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */var eG=document.createElement("template"),eY=`
  :host {
    --me-width: 32rem;
 ...
 */function(e,t=""){if(!t)return!0;let o=[...new Set(t.split(",").map(e=>e.trim()).filter(Boolean))],i=e.type,a=i.replace(/\/.*$/,"");for(let t of o)if("."===t.charAt(0)){if(-1!==e.name.toLowerCase().indexOf(t.toLowerCase(),e.name.length-t.length))return!0}else if(/\/\*$/.test(t)){if(a===t.replace(/\/.*$/,""))return!0}else if(i===t)return!0;return!1}(i,this.accept),a=i.size>this.maxSize,n=i.size<this.minSize;if(!e||a||n){let t=[];e||t.push({code:"INVALID_MIME_TYPE",message:`File type "${i.type}" is not accepted.`}),a&&t.push({code:"FILE_TOO_LARGE",message:`File size ${i.size} exceeds the maximum size of ${this.maxSize}.`}),n&&t.push({code:"FILE_TOO_SMALL",message:`File size ${i.size} is smaller than the minimum size of ${this.minSize}.`}),o.push({file:i,errors:t})}else t.push(i)}this.dispatchEvent(new CustomEvent(`${e9}-drop`,{bubbles:!0,composed:!0,detail:{acceptedFiles:t,rejectedFiles:o}})),t.length>0&&this.dispatchEvent(new CustomEvent(`${e9}-drop-accepted`,{bubbles:!0,composed:!0,detail:{acceptedFiles:t}})),o.length>0&&this.dispatchEvent(new CustomEvent(`${e9}-drop-rejected`,{bubbles:!0,composed:!0,detail:{rejectedFiles:o}})),this.#t&&(this.#t.value=this.#t.defaultValue)}openFileDialog(){this.disabled||this.#t?.click()}#l(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}}static defineCustomElement(t=e9){"u">typeof window&&!window.customElements.get(t)&&window.customElements.define(t,e)}}).defineCustomElement();const te=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"],tt=(e="",t="")=>{let o=Math.random().toString(36).substring(2,8);return`${"string"==typeof e&&""!==e?e+"-":""}${o}${"string"==typeof t&&""!==t?"-"+t:""}`},to=async(e={})=>{let t=await fetch(e.url),o=await t.blob(),i=e.mimeType||o.type||"";if(!te.includes(i))throw Error(`This is not an accepted image format. Accepted MIME types are: ${te.join(", ")}`);return new File([o],e.filename||"",o)},ti=localStorage,ta=new class{#g=null;#b=null;constructor(e,t=localStorage){if(!e)throw Error("Storage prefix is required");if(t!==localStorage&&t!==sessionStorage)throw Error("Storage provider is not supported");this.#g=e,this.#b=t}set(e,t){try{this.#b.setItem(`${this.#g}${e}`,JSON.stringify(t))}catch(e){console.error("Error saving to storage",e)}}get(e){try{let t=this.#b.getItem(`${this.#g}${e}`);return t?JSON.parse(t):null}catch(e){return console.error("Error getting from storage",e),null}}}("meme-generator/",ti),tn=e=>"string"==typeof e;var tr={};tr=new URL("Pressuru.684952ea.ttf",import.meta.url).toString();var ts={};ts=new URL("Oswald-Regular.89ec7d89.ttf",import.meta.url).toString();var tl={};tl=new URL("Oswald-Bold.0f6a7ca6.ttf",import.meta.url).toString();var td={};td=new URL("Roboto-Regular.ca197847.ttf",import.meta.url).toString();var tc={};tc=new URL("Roboto-Bold.fdb9b54a.ttf",import.meta.url).toString();var tu={};tu=new URL("RobotoCondensed-Regular.d585f5c7.ttf",import.meta.url).toString();var th={};th=new URL("RobotoCondensed-Bold.e1f96d4b.ttf",import.meta.url).toString();var tm={};tm=new URL("CourierPrime-Regular.3a25a501.ttf",import.meta.url).toString();var tp={};tp=new URL("CourierPrime-Bold.3d6bf689.ttf",import.meta.url).toString();var tg={};tg=new URL("OpenSans-Regular.edf9e01b.ttf",import.meta.url).toString();var tb={};tb=new URL("OpenSans-Bold.8fceb72b.ttf",import.meta.url).toString();const tf=[{name:"Pressuru",label:"Pressuru",path:o(tr),style:"normal",weight:"400"},{name:"Oswald-Regular",label:"Oswald",path:o(ts),style:"normal",weight:"400"},{name:"Oswald-Bold",label:"Oswald Bold",path:o(tl),style:"normal",weight:"700"},{name:"Roboto-Regular",label:"Roboto",path:o(td),style:"normal",weight:"400"},{name:"Roboto-Bold",label:"Roboto Bold",path:o(tc),style:"normal",weight:"700"},{name:"RobotoCondensed-Regular",label:"Roboto Condensed",path:o(tu),style:"normal",weight:"400"},{name:"RobotoCondensed-Bold",label:"Roboto Condensed Bold",path:o(th),style:"normal",weight:"700"},{name:"CourierPrime-Regular",label:"Courier Prime",path:o(tm),style:"normal",weight:"400"},{name:"CourierPrime-Bold",label:"Courier Prime Bold",path:o(tp),style:"normal",weight:"700"},{name:"OpenSans-Regular",label:"Open Sans",path:o(tg),style:"normal",weight:"400"},{name:"OpenSans-Bold",label:"Open Sans Bold",path:o(tb),style:"normal",weight:"400"}],tv=async(e,t,o={})=>{try{let i=new FontFace(e,`url(${t})`,{...o});await i.load(),document.fonts.add(i)}catch(e){console.error(e)}},ty=document.getElementById("errorsContainer"),tw=e=>{let t=e.currentTarget;t.removeEventListener("click",tw),ty.removeChild(t.parentNode)},tk=(e="",t="info")=>{["info","warning","danger"].includes(t)||(t="info");let o=`
  ...
  `,p=document.createDocumentFragment(),g=document.createElement("div");g.setAttribute("id",i),g.setAttribute("data-section","textbox"),g.className="bg-body-tertiary border shadow-sm mb-3 rounded",g.innerHTML=m,g.querySelectorAll("select").forEach(e=>e.value=o[e.dataset.input]),g.querySelectorAll('input[type="checkbox"]').forEach(e=>e.checked=o[e.dataset.input]);let b=p.appendChild(g);return t&&setTimeout(()=>b.querySelector('[data-input="text"]').focus(),0),b}}class tC{#f=null;#v=null;constructor(e){this.#f=e,this.#v=this.#f.getContext("2d")}getCanvas(){return this.#f}get width(){return this.#f.width}set width(e){this.#f.width=e}get height(){return this.#f.height}set height(e){this.#f.height=e}getDimensions(){return{width:this.width,height:this.height}}setDimensions({width:e,height:t}){return this.width=e,this.height=t,this}toDataURL(){return this.#f.toDataURL()}draw(e,t=new Map){if(null==e)return;let o=this.#f,i=this.#v;i.clearRect(0,0,o.width,o.height),tn(e)?(i.fillStyle=e,i.fillRect(0,0,o.width,o.height)):i.drawImage(e,0,0,o.width,o.height);let a=0;return t.forEach(e=>{let{data:t}=e;a+=1,i.save(),i.font=`${t.fontWeight} ${t.fontSize*o.width/1e3}px ${t.font}`,i.fillStyle=t.fillColor,i.textAlign=t.textAlign,i.strokeStyle=t.strokeColor;let n=i.measureText("M").width+t.fontSize/2,r=o.width/2,s=t.shadowBlur,l=(!0===t.allCaps?t.text.toUpperCase():t.text).split("\n");0!==s&&(i.shadowOffsetX=0,i.shadowOffsetY=0,i.shadowBlur=Math.min(s,20),i.shadowColor=t.strokeColor),i.translate(r+t.offsetX,n*a+t.offsetY),i.rotate(Math.min(t.rotate,360)*Math.PI/180),l.forEach((e,t)=>i.fillText(e,0,t*n)),0!==s&&(i.shadowBlur=0,l.forEach((e,t)=>i.fillText(e,0,t*n))),t.strokeWidth>0&&(i.lineWidth=Math.min(t.strokeWidth,20),l.forEach((e,t)=>i.strokeText(e,0,t*n))),i.restore()}),this}clear(){return this.#v.clearRect(0,0,this.#f.width,this.#f.height),this}show(){return this.#f.hidden=!1,this}hide(){return this.#f.hidden=!0,this}static createInstance(e){return new tC(e)}}const tA=tC.createInstance(document.getElementById("canvas")),tj=document.getElementById("videoModal"),tT=document.getElementById("downloadModal"),tz=document.querySelector("capture-photo"),tL=document.getElementById("cameraSelect"),tD=document.getElementById("capturePhotoButton"),t_=document.getElementById("torchButton"),t$=document.querySelector("files-dropzone"),tI=document.getElementById("instructions"),tB=document.getElementById("imageUploadMethodSelect"),tM=document.getElementById("fileSelectBtn"),tR=document.getElementById("imageUrlForm"),tF=document.getElementById("addTextboxBtn"),tO=document.getElementById("textboxesContainer"),tN=document.getElementById("generateMemeBtn"),tP=document.getElementById("openVideoModalBtn"),tq=document.getElementById("downloadMemeBtn"),tU=document.getElementById("downloadMemePreview"),tH=document.querySelector("web-share"),tV=document.getElementById("gallery"),tW=document.getElementById("gallerySearch"),tX=tV.querySelector(".gallery__no-results"),tG=document.getElementById("sluggallery"),tY=document.getElementById("sluggallerySearch"),tK=tG.querySelector(".sluggallery__no-results"),tJ=document.getElementById("solidColorForm"),tQ=document.querySelectorAll(".upload-method"),tZ=document.getElementById("removeConfirmationModal"),t0=document.getElementById("removeTextForm"),t1=document.getElementById("maxImageDimensionsForm"),t3=t1.maxImageDimensions,t5=document.getElementById("clearCanvasBtn"),t2=ta.get("maxImageDimensions");let t4=!1,t9=null,t8=null,t6=!1;tA.getCanvas().addEventListener("touchstart",e=>{let t=tA.getCanvas().getBoundingClientRect(),o=e.clientX-t.left,i=e.clientY-t.top;(ctx=tA.getCanvas().getContext("2d")).getTransform();let a=0;tS.getAll().forEach(e=>{if(function(e,t,o,i){let a=2*(ctx=tA.getCanvas().getContext("2d")).measureText(o.data.text).width+o.data.fontSize;$canvas_discrepancy_plus=20,$padding_top=14;let n=tA.getCanvas().width/2+o.data.offsetX-a,r=o.data.offsetY,s=(ctx.measureText("M").width+o.data.fontSize/2)*i;return r=r+s-$padding_top,o.data.width=a,o.data.height=s,e>=n&&e<=n+2*a&&t>=r&&t<=r+s}(o,i,e,a+=1)){t6=!0,draggedTextbox=e;let t=tA.getCanvas().width/2,a=tA.getCanvas().height/2;startX=o-t-e.data.offsetX,startY=i-a-e.data.offsetY}})}),tA.getCanvas().addEventListener("touchmove",e=>{if(t6&&draggedTextbox){let t=tA.getCanvas().getBoundingClientRect(),o=e.clientX-t.left,i=e.clientY-t.top,a=tA.getCanvas().width/2,n=tA.getCanvas().height/2;draggedTextbox.data.offsetX=o-a-startX,draggedTextbox.data.offsetY=i-n-startY,tA.draw(t9,tS.getAll())}}),tA.getCanvas().addEventListener("touchend",()=>{t6=!1}),tA.getCanvas().addEventListener("mouseleave",()=>{t6=!1});const t7=async()=>{let e=tA.toDataURL("image/png"),t=`${tt("meme")}.png`,o=e.replace("image/png","image/octet-stream");if(tq.download=t,tq.href=o,tU.width=tA.getDimensions().width,tU.height=tA.getDimensions().height,tU.src=o,eq())try{let o=await to({url:e,filename:t,mimeType:"image/png"}).catch(e=>tk(e.message,"danger"));o&&eq({files:[o]})&&(tH.shareFiles=[o],tH.hidden=!1)}catch(e){console.error(e)}window.requestAnimationFrame(()=>{tT.open=!0})},oe=e=>{let[t,o]=t1.maxImageDimensions.value.split("x"),i=Number(t)||800,a=Number(o)||600,n=e.width,r=e.height;n>r?n>i&&(r*=i/n,n=i):r>a&&(n*=a/r,r=a),tA.setDimensions({width:n,height:r})},ot=()=>{tA.draw(t9,tS.getAll()).show(),t$.classList.add("dropzone--accepted"),t$.disabled=!0,tN.disabled=!1,tI.hidden=!0,t5.hidden=!1},oo=e=>{oe(t9=e.target),ot()},oi=e=>{if(!e)return;let t=new Image,o=new FileReader;o.addEventListener("load",function(e){let o=e.target.result;t.addEventListener("load",oo),t.src=o}),o.readAsDataURL(e)},oa=(e,t,o)=>{let i=tS.getById(t).getData();switch(e.type){case"checkbox":i[o]=e.checked;break;case"number":i[o]=Number(e.value);break;default:i[o]=e.value}tA.draw(t9,tS.getAll())},on=async e=>{e.preventDefault();let t=e.target,o=t.querySelector('button[type="submit"]'),i=t.imageUrl.value;if(i.trim()){o.disabled=!0,o.querySelector(".spinner").hidden=!1,o.querySelector(".label").hidden=!0;try{let e=await to({url:i}).catch(e=>tk(e.message,"danger"));e&&oi(e)}catch{tk(`Failed to load image from "${i}".`,"danger")}finally{o.disabled=!1,o.querySelector(".spinner").hidden=!0,o.querySelector(".label").hidden=!1}}},or=(e,t)=>()=>{let o=document.getElementById(e),i=o.querySelector('[data-input="offsetY"]'),a=o.querySelector('[data-input="offsetX"]'),n=tS.getById(e);if(!n)return;let r=n.getData();switch(t=t.toLowerCase()){case"up":r.offsetY-=1,i.value=r.offsetY;break;case"down":r.offsetY+=1,i.value=r.offsetY;break;case"left":r.offsetX-=1,a.value=r.offsetX;break;case"right":r.offsetX+=1,a.value=r.offsetX}tA.draw(t9,tS.getAll()),t8=requestAnimationFrame(or(e,t))},os=document.getElementById("imageUploadDetails"),ol=async e=>{let t=e.target.closest("button");if(!t)return;let o=t.querySelector("img");try{let e=await to({url:o.src}).catch(e=>tk(e.message,"danger"));e&&oi(e)}catch{tk(`Failed to load image: "${o.alt}".`,"danger")}},od=async e=>{let t=e.target.closest("button");if(!t)return;let o=t.querySelector("img");try{let e=await to({url:o.src}).catch(e=>tk(e.message,"danger"));e&&oi(e)}catch{tk(`Failed to load image: "${o.alt}".`,"danger")}},oc=(e={})=>{let{el:t,isTorchOn:o}={el:document.getElementById("torchButton"),isTorchOn:!1,...e},i=t.querySelectorAll("svg path");2===i.length&&(i[0].style.display=o?"none":"block",i[1].style.display=o?"block":"none",t.setAttribute("aria-label",`Turn ${o?"off":"on"} flash`))},ou=async e=>{let t=e.target.getTrackCapabilities();t?.torch&&(t_?.removeAttribute("hidden"),tz?.hasAttribute("torch")&&oc({el:t_,isTorchOn:!0}));let o=await eP.getVideoInputDevices();o.forEach((e,t)=>{let o=document.createElement("option");o.value=e.deviceId,o.textContent=e.label||`Camera ${t+1}`,tL.appendChild(o)}),o.length>1&&tL?.removeAttribute("hidden")};document.addEventListener("tt-theme-change",e=>{let t=e.detail.theme,o=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";document.documentElement.setAttribute("data-bs-theme","system"===t?o:t)}),document.addEventListener("web-share:error",()=>{tT.open=!1,tk("There was an error while trying to share your meme.","danger")}),document.addEventListener("capture-photo:video-play",ou,{once:!0}),document.addEventListener("capture-photo:error",e=>{let t=e.detail.error,o="An error occurred while trying to capture photo.";t instanceof Error&&("NotAllowedError"===t.name||"NotFoundError"===t.name)&&(o+=" Make sure you have a camera connected and you have granted the appropriate permissions."),tk(o,"danger"),tj.open=!1,console.error(t)}),document.addEventListener("capture-photo:success",e=>{tj.open=!1;let t=new Image;t.addEventListener("load",oo),t.src=e.detail.dataURI}),document.addEventListener("me-open",e=>{"videoModal"===e.target.id&&tz&&"function"==typeof tz.startVideoStream&&tz.startVideoStream()}),document.addEventListener("me-close",e=>{"videoModal"===e.target.id&&tz&&"function"==typeof tz.stopVideoStream&&tz.stopVideoStream(),"removeConfirmationModal"===e.target.id&&t0.reset()}),document.addEventListener("emoji-click",e=>{let t=e.target.closest('[data-section="textbox"]');if(t){let o=t.querySelector('[data-input="text"]'),i=e.detail.unicode;o&&eM(o,i)}}),document.addEventListener("textbox-create",e=>{let t=e.detail.textbox,o=tS.createElement(t,t4);t4=!0,tO.appendChild(o),t.getData().text&&tA.draw(t9,tS.getAll())}),document.addEventListener("textbox-remove",e=>{let t=document.getElementById(e.detail.id);t&&t.remove(),tO.querySelectorAll('[data-section="textbox"]').forEach((e,t)=>{e.querySelector('[data-input="text"]').setAttribute("placeholder",`Text #${t+1}`)}),tA.draw(t9,tS.getAll())}),tM.addEventListener("click",()=>{"function"==typeof t$.openFileDialog&&t$.openFileDialog()}),tP.addEventListener("click",()=>{tj.open=!0}),tF.addEventListener("click",()=>tS.create()),tN.addEventListener("click",t7),tq.addEventListener("click",()=>tT.open=!1),tR.addEventListener("submit",on),t$.addEventListener("files-dropzone-drop-accepted",e=>{let[t]=e.detail.acceptedFiles;t&&oi(t)}),tO.addEventListener("input",e=>{let t;let o=e.target,i=o.closest('[data-section="textbox"]').id;o.matches('[data-input="text"]')?t="text":o.matches('[data-input="fillColor"]')?t="fillColor":o.matches('[data-input="strokeColor"]')?t="strokeColor":o.matches('[data-input="font"]')?t="font":o.matches('[data-input="fontSize"]')?t="fontSize":o.matches('[data-input="fontWeight"]')?t="fontWeight":o.matches('[data-input="textAlign"]')?t="textAlign":o.matches('[data-input="shadowBlur"]')?t="shadowBlur":o.matches('[data-input="offsetY"]')?t="offsetY":o.matches('[data-input="offsetX"]')?t="offsetX":o.matches('[data-input="rotate"]')?t="rotate":o.matches('[data-input="strokeWidth"]')&&(t="strokeWidth"),t&&oa(o,i,t)}),tO.addEventListener("change",e=>{let t;let o=e.target,i=o.closest('[data-section="textbox"]').id;o.matches('[data-input="allCaps"]')&&(t="allCaps"),t&&oa(o,i,t)}),tO.addEventListener("click",e=>{let t=e.target;if(t.matches('[data-button="settings"]')){let e=t.closest('[data-section="textbox"]'),o=e?.querySelector('[data-section="settings"]');o&&(o.hidden=!o.hidden)}if(t.matches('[data-button="duplicate-text-box"')){let e=t.closest('[data-section="textbox"]'),o=tS.getById(e.id);tS.create({...o.data})}if(t.matches('[data-button="delete-text-box"]')){let e=t.closest('[data-section="textbox"]').id,o=tS.getById(e);if(o&&o.data.text.trim()){let t=t0["textbox-id"];t&&(t.value=e,tZ.open=!0)}else tS.remove(e)}}),tO.addEventListener("pointerdown",e=>{let t=e.target,o=t.closest('[data-section="textbox"]');o&&t.matches('[data-action="move-text"]')&&(t8=requestAnimationFrame(or(o.id,t.getAttribute("aria-label"))))}),tO.addEventListener("pointerup",e=>{e.target.matches('[data-action="move-text"]')&&(cancelAnimationFrame&&cancelAnimationFrame(t8),t8=null)}),tO.addEventListener("pointerout",e=>{e.target.matches('[data-action="move-text"]')&&(cancelAnimationFrame&&cancelAnimationFrame(t8),t8=null)}),tO.addEventListener("keydown",e=>{let t=e.target,o=t.closest('[data-section="textbox"]');t.matches('[data-action="move-text"]')&&(" "===e.key||"Enter"===e.key)&&(t8&&cancelAnimationFrame(t8),t8=requestAnimationFrame(or(o.id,t.getAttribute("aria-label"))))}),tO.addEventListener("keyup",e=>{e.target.matches('[data-action="move-text"]')&&(" "===e.key||"Enter"===e.key)&&(t8&&cancelAnimationFrame(t8),t8=null)}),tB.addEventListener("change",e=>{tQ.forEach(t=>t.hidden=t.id!==e.target.value),t1.hidden="solidColorForm"===e.target.value,os.removeAttribute("open")}),tV.addEventListener("click",ol),tW.addEventListener("input",e=>{let t=e.target.value.toLowerCase().trim();tV.querySelectorAll("button").forEach(e=>{let o=(e.querySelector("img").getAttribute("alt")||"").toLowerCase();e.hidden=!o.includes(t)}),tX.hidden=!!tV.querySelector("button:not([hidden])")}),tG.addEventListener("click",od),tY.addEventListener("input",e=>{let t=e.target.value.toLowerCase().trim();tG.querySelectorAll("button").forEach(e=>{let o=(e.querySelector("img").getAttribute("alt")||"").toLowerCase();e.hidden=!o.includes(t)}),tK.hidden=!!tG.querySelector("button:not([hidden])")}),tJ.addEventListener("input",e=>{e.target===tJ.canvasColor&&(t9=e.target.value),tn(t9)&&(tA.setDimensions({width:Number(tJ.canvasWidth.value)||800,height:Number(tJ.canvasHeight.value)||600}),ot())}),t0.addEventListener("submit",e=>{e.preventDefault();let t=e.target["textbox-id"].value;t&&(tS.remove(t),tZ.open=!1)}),t1.addEventListener("change",e=>{e.target.matches('[name="maxImageDimensions"]')&&ta.set("maxImageDimensions",e.target.value),!t9||tn(t9)||(oe(t9),tA.draw(t9,tS.getAll()))}),t5.addEventListener("click",e=>{t9&&(e.stopPropagation(),t9=null,t$.classList.remove("dropzone--accepted"),tN.disabled=!0,tI.hidden=!1,t5.hidden=!0,t$.disabled=!1,tA.clear().hide())}),tL.addEventListener("change",e=>{if(null===tz||"function"!=typeof tz.restartVideoStream||tz.hasAttribute("loading"))return;let t=e.target.value||void 0;tz.restartVideoStream(t)}),tD.addEventListener("click",()=>{null===tz||"function"!=typeof tz.capture||tz.hasAttribute("loading")||tz.capture()}),t_.addEventListener("click",e=>{null!==tz&&(tz.torch=!tz.torch,oc({el:e.currentTarget,isTorchOn:tz.hasAttribute("torch")}))}),tV.querySelectorAll("button > img")?.forEach(e=>{e.setAttribute("title",e.getAttribute("alt"))}),tG.querySelectorAll("button > img")?.forEach(e=>{e.setAttribute("title",e.getAttribute("alt"))}),tS.create(),t$.accept=te,((e,t)=>{if(!t)return;let o=e.map(e=>e.split("/")[1]),i=`Supported image formats: ${o.join(", ")}`,a=document.createElement("div"),n=document.createElement("small");n.textContent=i,a.appendChild(n),t.appendChild(n)})(te,tI),tf.forEach(({name:e,path:t,style:o,weight:i})=>{tv(e,t,{style:o,weight:i})}),t2&&(t3.value=t2),t3.disabled=!1;
//# sourceMappingURL=index.6fc098e1.js.map
